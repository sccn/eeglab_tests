function tests = t_pop_topoplot_colorbar
% Regression tests for the component colorbar ticks drawn by pop_topoplot.
% Moved from sccn/eeglab tests/test_pop_topoplot_colorbar.m (sccn/eeglab PR 956).
