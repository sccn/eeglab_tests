function tests = t_pop_selectevent
% Regression tests for pop_selectevent epoch and event selection.
% Moved from sccn/eeglab tests/test_pop_selectevent.m (sccn/eeglab PR 955).
