...
readsamplestudy;
[STUDY ALLEEG] = std_precomp(STUDY, ALLEEG, 'components', 'savetrials','on','recompute','on', 'interp', 'on', 'erp','on', 'spec', 'on', 'specparams', {'specmode', 'fft' }, 'ersp','on', 'itc','on', 'erspparams', {'ntimesout', 12, 'nfreqs', 10  'verbose' 'off'});
