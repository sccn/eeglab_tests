...
EEGOUT = mypop_rejtrend(EEG, 1, 1:32, 384, 0.5, 0.5, 0, 1, 0);
...
EEGOUT = mypop_rejtrend(EEG, 0, 1:30, 384, 0.5, 0.5, 0, 1, 0);
EEGOUT = mypop_rejtrend(EEG, 0, 1:30, 384, 0.5, 0.5, 0, 0, 0);
EEGOUT = mypop_rejtrend(EEG, 0, 1:30, 384, 0.5, 0.5, 1, 1, 0);
EEGOUT = mypop_rejtrend(EEG, 0, 1:30, 384, 0.5, 0.5, 1, 0, 0);

EEGOUT = mypop_rejtrend(EEG, 0, 1:30, 384, 0.5, 1, 0, 1, 0);
EEGOUT = mypop_rejtrend(EEG, 0, 1:30, 384, 0.5, 0.5, 0, 1, 0);
EEGOUT = mypop_rejtrend(EEG, 0, 1:30, 384, 10, 0.5, 0, 1, 0);
EEGOUT = mypop_rejtrend(EEG, 0, 1:30, 1000, 0.5, 0.5, 0, 1, 0);
EEGOUT = mypop_rejtrend(EEG, 0, [2 4 5], 384, 0.5, 0.5, 0, 1, 0);
